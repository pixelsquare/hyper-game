...
{
    public class UbeSceneTemplatePipeline : ISceneTemplatePipeline
    {
        private const string SCENE_PATH = "Assets/_Source/Content/Scenes/Quantum/Hangout/";
        
        private const string MAP_DATA_PATH = "Assets/_Source/Content/QuantumAssets/Hangout/Levels";
        ...
        private static bool CreateLevelConfig(Scene scene, string assetName, MapAsset mapAsset, out LevelConfigScriptableObject levelConfig)
        {
            ...
            levelConfig.EditorSetLevelConfig(scene.name, mapAsset);
