...
{
    public class UserProfileGenderScreen : MonoBehaviour
    {
        public static int userProfileGender;

        [SerializeField] private Button btnNext;
        [SerializeField] private UserProfileSelection[] selections;
        [SerializeField] private UnityEvent onGenderProfileSubmitted;
        ...
        {
            onGenderProfileSubmitted?.Invoke();
        }
        ...
        private void ActivateButton(UserProfileSelection selectionToActivate)
        {
            ...
            userProfileGender = Array.IndexOf(selections, selectionToActivate);
        }
        ...
        private void OnEnable()
        {
            ...
            GlobalNotifier.Instance.Trigger(new UserJourneyEvent(UserJourneyEvent.Checkpoint.Gender));
        }
