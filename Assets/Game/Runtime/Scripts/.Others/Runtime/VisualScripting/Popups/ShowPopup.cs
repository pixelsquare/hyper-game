...
namespace Kumu.Kulitan.VisualScripting
{
    ...
    public class ShowPopup : WaitUnit
    {
        [DoNotSerialize]
        ...
        protected override void Definition()
        {
            ...
            confirmButton = ValueInput(nameof(confirmButton), "Ok");
            cancelButton = ValueInput(nameof(cancelButton), "Cancel");
            popupType = ValueInput(nameof(popupType), PopupManager.PopupType.ConfirmationPopup);
        ...
        protected override IEnumerator Await(Flow flow)
        {
            ...
            var popup = PopupManager.CreatePopup(flow.GetValue<PopupManager.PopupType>(popupType), 0) as ConfirmationPopup;
            popup.SetDetails(
